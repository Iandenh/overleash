module github.com/Iandenh/overleash/frankenphp

go 1.25.4

replace github.com/Iandenh/overleash => ../

require (
	github.com/Iandenh/overleash v1.0.3
...
require (
	...
	github.com/teal-finance/fuzzy v0.2.0 // indirect
